...
function Section({ id, title, children }: { id: string; title: string; children: React.ReactNode }) {
  return (
    <section id={id} aria-labelledby={`${id}-heading`} className="scroll-mt-20">
      <h2 id={`${id}-heading`} className="text-2xl font-bold text-gray-900 mb-4 pb-2 border-b border-gray-200">
        {title}
      </h2>
      {children}
    </section>
...
function SubSection({ id, title, children }: { id: string; title: string; children: React.ReactNode }) {
  return (
    <div id={id} className="scroll-mt-20">
      <h3 id={`${id}-heading`} className="text-xl font-semibold text-gray-800 mb-3 mt-6">{title}</h3>
      {children}
    </div>
  )
}
...
function CodeBlock({ children }: { children: string }) {
  return (
    <pre className="bg-gray-900 text-gray-100 rounded-lg p-4 text-sm overflow-x-auto my-3" role="img" aria-label="Ejemplo de código">
      <code>{children}</code>
    </pre>
  )
}
...
export default function DocsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <a href="#main-content" className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:bg-white focus:px-4 focus:py-2 focus:rounded-lg focus:shadow-lg focus:text-blue-700 focus:font-medium">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              <Link href="/" className="text-xl font-bold text-gray-900 hover:text-blue-600 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 rounded">
                autonomIA
              </Link>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="lg:grid lg:grid-cols-[250px_1fr] lg:gap-8">
            ...
            <ul className="space-y-1" role="list">
              {navItems.map((item) => (
                <li key={item.id}>
                  <a
                    href={`#${item.id}`}
                    className={`block px-3 py-1.5 text-sm rounded-md transition-colors hover:bg-gray-100 hover:text-gray-900 text-gray-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 ${
          ...
          <main id="main-content" className="space-y-12" role="main">
            <div className="mb-8">
              <h1 className="text-4xl font-bold text-gray-900 mb-3">Documentación de autonomIA</h1>
            ...
            <Section id="overview" title="Visión general">
              ...
              <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {[
                  ...
                  <div key={feature.title} className="bg-white rounded-lg p-4 border border-gray-200">
                ...
                <table className="w-full text-sm" role="table">
                  ...
                  <thead>
                    <tr className="border-b border-gray-200">
                      <th scope="col" className="text-left py-2 pr-4 font-semibold text-gray-900">Tecnología</th>
                      <th scope="col" className="text-left py-2 pr-4 font-semibold text-gray-900">Versión</th>
                      <th scope="col" className="text-left py-2 font-semibold text-gray-900">Uso</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-100">
                    {[
                      ...
                      <tr key={tech}>
                        <td className="py-2 pr-4 font-medium text-gray-900">{tech}</td>
                        <td className="py-2 pr-4 text-gray-600">{version}</td>
                        <td className="py-2 text-gray-600">{usage}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
    ...
    └── index.ts        # Interfaces TypeScript`}</CodeBlock>
            ...
            <Section id="conventions" title="Convenciones de código">
              <ul className="space-y-3 text-gray-700" role="list">
                ...
                <li className="flex gap-2"><span className="text-green-600 font-bold shrink-0" aria-hidden="true">+</span> Server Components por defecto; <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">&apos;use client&apos;</code> solo para interactividad</li>
                ...
                <li className="flex gap-2"><span className="text-green-600 font-bold shrink-0" aria-hidden="true">+</span> TypeScript estricto — nunca <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">any</code></li>
                ...
                <li className="flex gap-2"><span className="text-green-600 font-bold shrink-0" aria-hidden="true">+</span> Fechas formateadas en español: <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">21 mar 2026</code></li>
                <li className="flex gap-2"><span className="text-red-600 font-bold shrink-0" aria-hidden="true">-</span> No enviar <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">user_id</code> desde el cliente — usar <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">DEFAULT auth.uid()</code></li>
                <li className="flex gap-2"><span className="text-red-600 font-bold shrink-0" aria-hidden="true">-</span> No usar <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">user!</code> sin null check en Server Components</li>
              </ul>
            </Section>

            <Section id="accessibility" title="Accesibilidad — WCAG 2.2 Nivel AA+">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                <p className="text-blue-900 font-medium mb-1">Compromiso de accesibilidad</p>
              ...
              <SubSection id="a11y-perceptible" title="1. Perceptible">
                <p className="text-gray-600 mb-3">El contenido debe ser presentable de formas que el usuario pueda percibir.</p>
                <ul className="space-y-1" role="list">
                  ...
                  <GuidelineItem criterion="1.1.1" level="A">
                    <strong>Texto alternativo</strong>: Todo <code className="bg-gray-100 px-1 rounded text-xs">&lt;img&gt;</code> con <code className="bg-gray-100 px-1 rounded text-xs">alt</code> descriptivo.
                    Iconos decorativos con <code className="bg-gray-100 px-1 rounded text-xs">aria-hidden=&quot;true&quot;</code>.
                  </GuidelineItem>
              ...
              <SubSection id="a11y-operable" title="2. Operable">
                <p className="text-gray-600 mb-3">Los componentes de la interfaz deben ser operables por cualquier usuario.</p>
                <ul className="space-y-1" role="list">
                  ...
                  <GuidelineItem criterion="2.4.7" level="AA">
                    ...
                    Usar <code className="bg-gray-100 px-1 rounded text-xs">focus-visible:ring-2</code> de shadcn.
                  </GuidelineItem>
                  ...
                  <GuidelineItem criterion="2.4.2" level="A">
                    <strong>Títulos de página</strong>: Cada ruta con <code className="bg-gray-100 px-1 rounded text-xs">&lt;title&gt;</code> descriptivo
              ...
              <SubSection id="a11y-comprensible" title="3. Comprensible">
                <p className="text-gray-600 mb-3">La información y la operación de la interfaz deben ser comprensibles.</p>
                <ul className="space-y-1" role="list">
                  <GuidelineItem criterion="3.1.1" level="A">
                    <strong>Idioma</strong>: <code className="bg-gray-100 px-1 rounded text-xs">&lt;html lang=&quot;es&quot;&gt;</code> en el layout raíz.
                  </GuidelineItem>
                  <GuidelineItem criterion="3.3.2" level="A">
                    <strong>Labels</strong>: Todo input con <code className="bg-gray-100 px-1 rounded text-xs">&lt;label&gt;</code> asociado.
                  ...
                  <GuidelineItem criterion="3.3.1" level="A">
                    ...
                    <code className="bg-gray-100 px-1 rounded text-xs">aria-describedby</code>.
                  </GuidelineItem>
                  <GuidelineItem criterion="3.3.4" level="AA">
                    ...
                    no <code className="bg-gray-100 px-1 rounded text-xs">window.confirm()</code>.
                  </GuidelineItem>
                  <GuidelineItem criterion="3.2.6" level="A">
                    <strong>Feedback de estado</strong>: Las acciones comunican su resultado con
                    <code className="bg-gray-100 px-1 rounded text-xs">aria-live=&quot;polite&quot;</code>.
                  </GuidelineItem>
              ...
              <SubSection id="a11y-robusto" title="4. Robusto">
                <p className="text-gray-600 mb-3">El contenido debe ser lo suficientemente robusto para tecnologías asistivas.</p>
                <ul className="space-y-1" role="list">
                  <GuidelineItem criterion="4.1.2" level="A">
                    <strong>HTML semántico</strong>: Usar <code className="bg-gray-100 px-1 rounded text-xs">&lt;main&gt;</code>,{' '}
                    <code className="bg-gray-100 px-1 rounded text-xs">&lt;nav&gt;</code>,{' '}
                    <code className="bg-gray-100 px-1 rounded text-xs">&lt;header&gt;</code>,{' '}
                    <code className="bg-gray-100 px-1 rounded text-xs">&lt;section&gt;</code>. No divs genéricos para estructura.
                  </GuidelineItem>
                  <GuidelineItem criterion="4.1.2" level="A">
                    <strong>Tablas accesibles</strong>: <code className="bg-gray-100 px-1 rounded text-xs">&lt;th scope=&quot;col&quot;&gt;</code>,{' '}
                    <code className="bg-gray-100 px-1 rounded text-xs">&lt;caption&gt;</code> en tablas de datos.
                  </GuidelineItem>
                  <GuidelineItem criterion="4.1.3" level="AA">
                    <strong>Live regions</strong>: <code className="bg-gray-100 px-1 rounded text-xs">aria-live</code> para
                    contenido que cambia dinámicamente.
                  </GuidelineItem>
                  <GuidelineItem criterion="4.1.2" level="A">
                    <strong>Landmarks</strong>: <code className="bg-gray-100 px-1 rounded text-xs">&lt;nav&gt;</code> para sidebar,{' '}
                    <code className="bg-gray-100 px-1 rounded text-xs">&lt;main&gt;</code> para contenido.
                  </GuidelineItem>
                  <GuidelineItem criterion="4.1.2" level="A">
                    <strong>ARIA correcta</strong>: Los componentes shadcn ya incluyen roles correctos. No duplicar ni inventar roles.
                    Solo <code className="bg-gray-100 px-1 rounded text-xs">tabIndex</code> 0 o -1, nunca positivos.
                  </GuidelineItem>
                </ul>
              </SubSection>
            </Section>
            ...
            <Section id="checklist" title="Checklist de PR">
              <p className="text-gray-600 mb-4">Antes de enviar cada Pull Request, verificar:</p>
              <div className="bg-white rounded-lg border border-gray-200 divide-y divide-gray-100">
                {[
                  ...
                  <div key={i} className="flex items-start gap-3 px-4 py-3">
                    <span className="w-5 h-5 rounded border-2 border-gray-300 shrink-0 mt-0.5" aria-hidden="true" />
            ...
            <Section id="commands" title="Comandos">
              <div className="space-y-2">
                {[
                  ...
                  <div key={cmd} className="flex items-center gap-4 bg-white rounded-lg border border-gray-200 px-4 py-3">
                    <code className="bg-gray-900 text-gray-100 px-3 py-1 rounded text-sm font-mono">{cmd}</code>
            ...
            <Section id="changelog" title="Historial de cambios">
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Sin publicar</h3>
                  <div className="space-y-3">
                    <div>
                      <h4 className="text-sm font-semibold text-green-700 uppercase tracking-wide mb-1">Añadido</h4>
                      <ul className="text-sm text-gray-700 space-y-1 list-disc list-inside" role="list">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">0.1.0 — 2026-03-21</h3>
                  <div>
                    <h4 className="text-sm font-semibold text-green-700 uppercase tracking-wide mb-1">Añadido</h4>
                    <ul className="text-sm text-gray-700 space-y-1 list-disc list-inside" role="list">
